...
// 把com.vondear.rxfeature.activity包下的ActivityScanerCode拿过来
// 这里可以说用继承来复用代码，但是因为它本身有的东西设置为private了，同时没有get方法，所以我们直接copy过来所有代码
public class ScanQrCodeActivity extends FragmentActivity {
    ...
    // sxd : 在这里覆盖之前的逻辑 实现跳转到TicketActivity界面
    //
...
//            ToastUtil.showToast("当前二维码非法");
    ...
    // sxd 重写finish方法 让activity退出到后台 但是不销毁
    @Override
    public void finish() {
        moveTaskToBack(true);
    }
